...
<% } else { %>
	...
	<script type='text/javascript' src='/oec/dwr/util.js'></script>
        ...
        function buildPage()
        {
            ...
            responses.getTaggedResponsesCount(displayTagged);
        ...
        function getGraph()
        {
            document.getElementById('resultGraph').innerHTML = "<font class='load'>Loading <img src='/oec/images/progressBar.gif' border='0'/></font>";
        ...
        function displayGraph(data)
        {
            ...
            out = out+"<th>W</th><th>Qlabel</th><th>Program Event Id</th><th>Total Questions</th><th>Unverifed</tv><th>Tagged</th><th>Verified</th><th>new</th>";
            for (var i = 0; i < data.length; i++)
            {
                var result = data[i];
                out = out+"<tr><td>"+result.groupQuestionLabel+"</td><td>"+result.surveyQuestionLabel+"</td><td>"+result.programEventId+"</td><td>"+result.totalCount+"</td><td>"+result.countUnverify+"</td><td>"+result.countTag+"</td><td>"+result.countVerify+"</td><td>"+result.countNew+"</td></tr>";                            	 	
            ...
            graph_table = graph_table+"<tr><td><img src=\"/oec/images/red_dot.gif\" height=\"50\" width=\""+per_uncoded+"\" alt=\""+total_uncoded+" uncoded.\"/></td></tr>";
            graph_table = graph_table+"<tr><td> <img src=\"/oec/images/green_dot.gif\" height=\"50\" width=\""+per_inprogress+"\" alt=\""+total_inprogress+" have been coded.\"/></td></tr></table>";
            
            graph_table = graph_table+ "<table align=\"left\" class=\"graph\" width=\"100\"><tr><th colspan=\"2\">Tag & UV ("+total_tag_unverify+")</th></tr>";
            graph_table = graph_table+"<tr><td><img src=\"/oec/images/red_dot.gif\" height=\"50\" width=\""+per_tagged+"\" alt=\""+total_tagged+" tagged.\"/></td></tr>";
            graph_table = graph_table+"<tr><td> <img src=\"/oec/images/green_dot.gif\" height=\"50\" width=\""+per_unverify+"\" alt=\""+total_unverify+" unverified.\"/></td></tr></table>";
            //alert(graph_table);
...
<body class="admin" onload="buildPage();">
    ...
    <div id="review">
        ...
        <center><a href="discrep_rpt.jsp" class="buttonU" onClick="">Detail Report</a>&nbsp;</center>
    </div>
